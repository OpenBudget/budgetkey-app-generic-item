...
import { DescriptorBase, GovUnitDescriptor } from '../../../model';

import * as _ from 'lodash';
import { BaseItemInfoComponent } from '../../base-item-info';

@Component({
  selector: 'gov-unit-item-info',
  template: `
...
export class GovUnitItemInfoComponent extends BaseItemInfoComponent {

  descriptor: GovUnitDescriptor;

  setDescriptor(descriptor: DescriptorBase) {
    this.descriptor = <GovUnitDescriptor>this.store.descriptor;
  }
}
